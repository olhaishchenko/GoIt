...
from FileOutputHandler import *
from ConsoleOutputHandler import *


class Bot:
    def __init__(self, output_handler_type):
        self.book = AddressBook()
        if output_handler_type == "file":
            self.output_handler = FileOutputHandler()
        elif output_handler_type == "console":
        ...
        if action == 'add':
            ...
            for account in result:
                if account['birthday']:
                    ...
                    self.output_handler.out(result)
        elif action == 'edit':
            ...
            self.output_handler.out(self.book.congratulate())
        elif action == 'view':
            self.output_handler.out(self.book)
        elif action == 'exit':
            pass
        else:
