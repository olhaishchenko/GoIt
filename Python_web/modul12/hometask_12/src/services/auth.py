...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param plain_password: Pass in the password entered by the user
        :param hashed_password: Compare the hashed password stored in the database with a new plain text password that
    ...
    def get_password_hash(self, password: str):
        ...
        :param self: Represent the instance of the class
        :param password: str: Receive the password that is being hashed
